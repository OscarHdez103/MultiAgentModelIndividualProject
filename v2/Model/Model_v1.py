...
class Model_v1(BaseModel):
    ...
    def __init__(self, llm:RequestLLM|None, database:Data, opinions:int, k:int, p:float, n:int=10, bots:int=0, seed:float|None=None, EXTREMIST_BOTS:bool=None, weights:Weights=None):
        super().__init__(llm=llm, database=database, defined_agent=Agent, n=n, bot_type=Agent_v1_Bot, bots=bots, seed=seed, graph=watts_strogatz_graph(n=n+bots, k=k, p=p, seed=seed), opinions=opinions, EXTREMIST_BOTS=EXTREMIST_BOTS, weights=weights)
