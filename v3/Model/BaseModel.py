...
class BaseModel(mesa.Model):
    ...
    def __init__(self, database:Data, defined_agent:type[Agent], n:int=10, bot_type:type[Agent]=None, bots:int=0, seed=None, graph: nx.Graph = None, opinions: int=-1, EXTREMIST_BOTS:bool=None, weights:Weights=None) -> None:
